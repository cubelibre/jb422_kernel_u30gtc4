...
static struct rkcamera_platform_data new_camera[] = {
    ...
    */
    new_camera_device_ex(RK29_CAM_SENSOR_GC2145,
                        ...
                        INVALID_VALUE,
                        RK30_PIN3_PB4,
                        CONS(RK29_CAM_SENSOR_GC2145,_PWRDN_ACTIVE),
                        1,
    ...
    /*                    
	new_camera_device_ex(RK29_CAM_SENSOR_GT2005,
                        back,
                        INVALID_VALUE,
                        INVALID_VALUE,
                        INVALID_VALUE,
...
#define CONFIG_SENSOR_FALSH_PIN_0		  RK30_PIN0_PD7
...
#define CONFIG_SENSOR_01  RK29_CAM_SENSOR_OV2659                   /* back camera sensor 1 */
#define CONFIG_SENSOR_IIC_ADDR_01 	    0x00
#define CONFIG_SENSOR_IIC_ADAPTER_ID_01    3
#define CONFIG_SENSOR_ORIENTATION_01       90
#define CONFIG_SENSOR_POWER_PIN_01         INVALID_GPIO
#define CONFIG_SENSOR_RESET_PIN_01         INVALID_GPIO
#define CONFIG_SENSOR_POWERDN_PIN_01       RK30_PIN3_PB4
#define CONFIG_SENSOR_FALSH_PIN_01         RK30_PIN0_PD7
...
#define CONFIG_SENSOR_POWERDN_PIN_1 	  RK30_PIN3_PB5//RK30_PIN3_PB4
...
#define CONFIG_SENSOR_POWERDN_PIN_11       RK30_PIN3_PB5//RK30_PIN1_PB7
...
#define CONFIG_SENSOR_FALSH_EN_PIN_0		  RK30_PIN0_PD7   //high:enable
...
{            
		...
		case Flash_On: {
			if(strcmp(res->dev_name, "gt2005_front_4")==0)
			{
				gpio_set_value(CONFIG_SENSOR_FALSH_EN_PIN_0, 0);
				gpio_set_value(CONFIG_SENSOR_FALSH_MODE_PIN_0, 0);
				break;
