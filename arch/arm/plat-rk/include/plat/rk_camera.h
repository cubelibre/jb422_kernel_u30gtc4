...
#define new_camera_device_ex(sensor_name,\
        ...
        {\
            ...
            .io = {\
                .gpio_power = pwr_io,\
                .gpio_reset = INVALID_VALUE,\
                .gpio_powerdown = pwdn_io,\
                .gpio_flash = flash_io,\
                .gpio_flag = ((pwr_active&0x01)<<RK29_CAM_POWERACTIVE_BITPOS)|((flash_active&0x01)<<RK29_CAM_RESETACTIVE_BITPOS)|((pwdn_active&0x01)<<RK29_CAM_POWERDNACTIVE_BITPOS),\
            },\
            .orientation = ori,\
            .resolution = res,\
            .mirror = mir,\
